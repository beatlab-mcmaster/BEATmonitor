...
`<project root>/src/monitord/` in a terminal, then run:
...
program) is important because Blutooth range is limited (to approx. 100
...
the record, can take *20--30 minutes per hour* of data.
